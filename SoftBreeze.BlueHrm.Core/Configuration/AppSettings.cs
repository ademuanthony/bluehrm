namespace SoftBreeze.BlueHrm.Configuration
{
    /// <summary>
    ...
    public static class AppSettings
    {
        ...
        {
            public const string LeavePeriodStartDate = "Abb.Leave.LeavePeriodStartDate";
            public const string LeavePeriodEndDate = "Abb.Leave.LeavePeriodEndDate";
        }
    }
}