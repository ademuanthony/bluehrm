(function () {
    $(function () {
        ...
        var _createOrEditModal = new app.ModalManager({
            ...
            scriptUrl: abp.appPath + 'Areas/Admin/Views/Users/_CreateOrEditModal.js',
            modalClass: 'CreateOrEditUserModal'
        });

        var _userPermissionsModal = new app.ModalManager({
            viewUrl: abp.appPath + 'Admin/Users/PermissionsModal',
            scriptUrl: abp.appPath + 'Areas/Admin/Views/Users/_PermissionsModal.js',
        ...
        _$usersTable.jtable({
            ...
            fields: {
                ...
                actions: {
                    ...
                    width: '9%',
                    sorting: false,
                    list: _permissions.edit || _permissions.changePermissions || _permissions.delete,
