...
using SoftBreeze.BlueHrm.Security;
using SoftBreeze.BlueHrm.Web.Controllers.Results;
using SoftBreeze.BlueHrm.Web.Models.Account;
using SoftBreeze.BlueHrm.Web.MultiTenancy;

namespace SoftBreeze.BlueHrm.Web.Controllers
{
    public class AccountController : BlueHrmControllerBase
    {
        ...
        public virtual async Task<ActionResult> Register(RegisterViewModel model)
        {
            try
            {
                ...
                if (model.IsExternalLogin)
                {
                    ...
                    model.Password = BlueHrm.Authorization.Users.User.CreateRandomPassword();
